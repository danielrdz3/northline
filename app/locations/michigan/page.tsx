...
export const metadata: Metadata = { title: "Michigan Service Areas | Northline Technology", description: "Explore Northline’s Michigan service-area directory. Location pages are published for useful, reviewed local information.", alternates: { canonical: "/locations/michigan/" } };
