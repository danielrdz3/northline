...
export const metadata: Metadata = { title: "Technology Insights | Northline Technology", description: "Practical guidance for managed IT, co-managed IT, cybersecurity, and consequential technology decisions.", alternates: { canonical: "/insights/" } };
