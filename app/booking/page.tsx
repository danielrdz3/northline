...
export const metadata: Metadata = { title: "Book a Conversation | Northline Technology", description: "Schedule a conversation with Northline Technology or share your priorities through the contact form.", alternates: { canonical: "/booking/" } };
